...
- Running `REINDEX CONCURRENTLY` (or `reindexdb --concurrently`) on a database
  ...
  (TTDB-1505).
- Incompatibility with the final Postgres 18 release leading to a compilation error

## [1.4.1] - 2025-09-16

### Added

- New configuration parameter `pipelinedb.ipc_socket_directory` to specify a
  custom directory for IPC Unix-domain sockets. This addresses incompatibility
  issues with backup utilities that would throw errors when attempting to copy
  socket files created in the data directory. By default, IPC sockets are now
  created in `/tmp` instead of the data directory (GL-53).
...
[unreleased]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.4.2-REL_18...REL_18_STABLE
[1.4.2]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.4.1-REL_18...1.4.2-REL_18
[1.4.1]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.4.0-REL_18...1.4.1-REL_18
[1.4.0]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.3.5-REL_18...1.4.0-REL_18
[1.3.5]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.3.4-REL_18...1.3.5-REL_18
[1.3.4]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.3.3-REL_18...1.3.4-REL_18
[1.3.3]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.3.2-REL_18...1.3.3-REL_18
[1.3.2]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.3.1-REL_18...1.3.2-REL_18
[1.3.1]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.3.0-REL_18...1.3.1-REL_18
[1.3.0]: https://gitlab.tantorlabs.ru/database/pipelinedb/-/compare/1.0.0-13...1.3.0-REL_18
