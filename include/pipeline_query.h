...
#define Anum_pipeline_query_part_duration 17
#define Anum_pipeline_query_part_attno    18
...
#define OPTION_PARTITION_ATTNO "partition_attno"
...
extern int continuous_view_index_fillfactor;
...
extern void DefineContView(Relation pipeline_query, Oid relid, Oid streamrelid, Oid matrel, Oid seqrel, int ttl, AttrNumber ttl_attno, double step_factor, int partition_duration, AttrNumber partition_attno, Oid *pq_id);
...
extern List *add_fillfactor(List *options, int fillfactor);
